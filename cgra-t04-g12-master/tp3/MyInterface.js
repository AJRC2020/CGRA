...
export class MyInterface extends CGFinterface {
    ...
    init(application) {
        ...
        var fgl = this.gui.addFolder("Global Light");
        fgl.add(this.scene.colors, '0', 0.01, 1.0).name("Red").onChange(this.scene.updadeGlobalLight.bind(this.scene));
        fgl.add(this.scene.colors, '1', 0.01, 1.0).name("Green").onChange(this.scene.updadeGlobalLight.bind(this.scene));
        fgl.add(this.scene.colors, '2', 0.01, 1.0).name("Blue").onChange(this.scene.updadeGlobalLight.bind(this.scene));
        fgl.add(this.scene.colors, '3', 0.01, 1.0).name("Alpha").onChange(this.scene.updadeGlobalLight.bind(this.scene));
