...
export class MyScene extends CGFscene {
    ...
    initLights() {
        this.colors = [0.3, 0.3, 0.3, 1.0];
        this.setGlobalAmbientLight(this.colors[0], this.colors[1], this.colors[2], this.colors[3]);
    ...
    updadeGlobalLight(){
        ...
        this.gl.uniform4f(this.activeShader.uniforms.uGlobalAmbient, this.colors[0], this.colors[1], this.colors[2], this.colors[3]);
    }
    ...
    initMaterials() {
        ...
        this.material4.setAmbient(0.5, 0.25, 0.1, 1.0);
        this.material4.setDiffuse(0.5, 0.25, 0.1, 1.0);
